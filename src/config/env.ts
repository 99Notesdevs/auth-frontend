export const env = {
    ...
    TEST_PORTAL_API: import.meta.env.VITE_TEST_PORTAL_URL || "http://test.main.local:5173",
    SHOP_PORTAL_API: import.meta.env.VITE_SHOP_PORTAL_URL || "http://shop.main.local:5173",
